...
\pagestyle{fancy}
\fancyhf{}
\lhead{Erd\H{o}s \#287 -- V16.8 Theory Manual R9}
\rhead{1 September 2026}
...
\large Clean Public Review + Self-Contained Gate Theory Manual\\[0.3ex]\normalsize Version 16.8 -- Public Review R9 (1 September 2026 source reconstruction)}
...
\section{31 August 2026 C0/transverse synchronization (historical checkpoint)}\label{sec:aug31sync}

This section records the 31-August analytic checkpoint.  It is retained as historical
provenance; the controlling R9 source/compiler status is Section~\ref{sec:sep1source}. Earlier R7
...
\section*{31 August 2026 historical final status (superseded by R9)}
\addcontentsline{toc}{section}{31 August 2026 historical final status}
\begin{center}
\small
\begin{tabular}{ll}
\toprule
